...
helm upgrade --install --wait --timeout=600s backup-restore /home/skutner/WebstormProjects/work/helm-charts/charts/backup-restore -f $BACKUP_RESTORE_SECRETS_FILE -f $BACKUP_RESTORE_CONFIG_FILE
